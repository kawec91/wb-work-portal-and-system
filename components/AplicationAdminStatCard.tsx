...
interface AplicationAdminStatCardProps {
  icon: string;
  text: string;
}

const AplicationAdminStatCard = ({
  icon,
  text,
}: AplicationAdminStatCardProps) => {
  return (
    <div className="h-24 w-32 flex items-center justify-between shadow shadow-current rounded-tr-md rounded-br-md">
      <div
        className={`h-full w-2 bg-red-500 border-t-[1px] border-red-500`}
      ></div>
...
export default AplicationAdminStatCard;
